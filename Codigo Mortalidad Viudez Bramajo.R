...
###cargo estos paquetes que voy a usar, el primero para leer los datos, el segundo para ordenar y hacer algunas operaciones sencillas de manipulación de datos...
library(readr)
library(tidyverse)
...
#Obtener estructura estándar (total de la población) 
...
###Para calcular las Tasas Estandarizadas de Mortalidad necesito antes las tasas específicas por grupos de edad 
